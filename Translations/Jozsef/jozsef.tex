...
1-4: \underline{e}-e(8)/á-a(9)/e-e(8)/\underline{á}-a(9) \\
5-8: \underline{á}-a(9)/\underline{e}-e(8)/\underline{á}-a(9)/e-e(8)
...
\noindent Chiastic structure: \\
1-4: e-ent(8)/aim-ban(9)/a-\underline{rend}(8)/i-an(9) \\
5-8: aim-ban(9)/a-\underline{rend}(8)/\underline{i}-\underline{an}(9)/e-ent(8)
...
\noindent Chiastic structure: \\
1-4: e-ret(8)/\underline{o}-cska(9)/e-ek(8)/\underline{o}-cska(9) \\
5-8: \underline{o}-cska(8)/e-ek(8)/\underline{a}-cska(8)/e-ret(8)
...
\noindent Chiastic structure: \\
1-4: o-\underline{a}(9)/\underline{i}-á(8)/o-a(9)/i-á(8) \\
5-8: i-á(8)/\underline{o}-a(9)/\underline{i}-á(8)/o-a(9)
...
\noindent Chiastic structure: \\
1-4: a-o(8)/é-e(9)/e-\underline{o}(8)/\underline{é}-e(9) \\
5-8: \underline{é}-e(9)/o-o(8)/é-e(9)/o-o(8)
...
\noindent Chiastic structure: \\
1-4: \underline{e}-ül(8)/á-at(9)/\underline{e}-ül(8)/\underline{á}-at(9) \\
5-8: \underline{á}-ad(9)/e-ül(8)/\underline{á}-at(9)/e-ül(8)
...
\noindent Chiastic structure: \\
1-4: \underline{a}-ól(8)/é-e(9)/a[i]-ól(9)/\underline{é}-e(9) \\
5-8: \underline{é}-e(9)/\underline{a}-ól(8)/é-e(9)/a-ol(8)
...
1-4: \underline{ü}-ött(8)/á-o(9)/\underline{ö}-ött(8)/á-o(9) \\
5-8: á-ok(9)/ö-ö(8)/\underline{á}-ok(9)/\underline{ö}-ött(8)
...
%% \noindent \textbf{Linear commentary}
...
%% strong. Self-consciousness, which has been relating the poem so far,
%% is golden, like the glow out of the kiln.
...
\noindent Chiastic structure: \\
1-4: \underline{a}-a[t](8)/e[t]-ni(9)/a-[d]t(8)/e[d]-ni(9) \\
5-8: e[t]-ni(9)/\underline{a}-a[tt](8)/e[t]-ni(9)/u-a[t](8)
