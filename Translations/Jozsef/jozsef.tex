...
\begin{flushright}
  This translation is dedicated to Jack \textsc{Kocsis}, \\
  \textsc{Juhász} Dávid and \textsc{Dudás} Réka.
\end{flushright}
...
\begin{verse}
  ...
  in summer. But, quietly, since nature has time,\hspace*{-1mm} \\
...
\begin{verse}
  ...
  as they are thrown down from the wagons.
...
\begin{verse}
  ...
  page~\pageref{only_you_should_read_my_poems}, where József refers to
