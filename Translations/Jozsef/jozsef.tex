...
\begin{verse}%[\versewidth]
  ...
  how it will resound in our neighbour's house, \\
  to the silent, austere day labourers, \\
  and in their tired, shattered dreams, \\
...
\begin{verse}%[\versewidth]
  ...
  D'ailleurs, j'ai récuré my petite table, \\
  et maintenant la lumière tendre de mon pain est plus pure. \\
  ...
  et Il m'aime aussi. \\
  Le Seigneur ne vient jamais dans tout l'éclat de sa gloire, \\
  ...
  et que tu seras gaie et que tu rougieras, \\
  et que tu regarderas vers le sol, \\
  et que nous éclaterons de rire, \\
  et que cela résonnera chez les voisins, \\
  vers les journaliers silencieux et austères, \\
  et, dans leurs rêves fatigués et brisés, \\
  eux aussi ils sourieront. \\
\end{verse}
...
\begin{verse}[\versewidth]
  ...
  lesikáltam\myfoot{vb. pref. \emph{le-} expressing downward
    direction, completion, continuous action till exhaustion}
  ...
  + 1st pers. sg. ind. pres. indef. \emph{-ek}} takarót vaságyamra. \\
  Egyszerű,\myfoot{\emph{egy} `one' + \emph{-szerű} `-like'
    $\rightarrow$ `plain/simple/unadorned/humble (< 1945)'}
  szürke\myfoot{adj. `grey'} takarót.\myfoot{vb. \emph{takar} `to
    cover (protect)' + pres. part. \emph{-ó} $\rightarrow$
    `cover/blanket' + acc. \emph{-t}} \\
  ...
  elromoljanak\myfoot{vb. pref. \emph{el-} completion +
  ...
  majd\myfoot{adv. `sometime/later'} elmosolyodnak\myfoot{TODO}
...
\begin{verse}[\versewidth]
  I live by a railroad. Many a train \\
  comes and goes, and I watch from afar \\
  how the bright windows fly by \\
  in the swaying, fluffy darkness. \\
  So the lit-up days rush \\
...
\settowidth{\versewidth}{Je vis près du chemin de fer. Nombreux sont les trains}

\begin{verse}[\versewidth]
  Je vis près du chemin de fer. Nombreux sont les trains \\
  qui viennent et vont, et j'observe de loin \\
  comment les fenêtres illuminées défilent \\
  dans l'obscurité oscillante et peluchée. \\
  Ainsi les jours éclairés se pressent \\
