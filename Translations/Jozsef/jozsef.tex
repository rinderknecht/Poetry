...
\begin{verse}%[\versewidth]
  ...
  and won't leave you in any memory. \\
  \ \\
  ...
  facing the sun you close your eyes, \\
\end{verse}
...
\begin{verse}[\versewidth]
  ...
  "Nem öleltem\myfoot{vb. \emph{ölel} `to embrace' + 1st
    pers. ind. past} meg,\myfoot{perfect. vb. pref. \emph{meg-}}
  hiszen\myfoot{conj. `as/because (smth obvious)'} nem
  ...
  s\myfoot{poetic abbrv. \emph{es} `and'
  (does not count as a syllable)} ki\myfoot{pron. rel. arch. `he who',
    alt. \emph{aki}} a nap\myfoot{\emph{nap} `sun/day'}
