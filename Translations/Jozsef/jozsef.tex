...
supporting the inescapable, recurring alternance of days and
nights.
...
\settowidth{\versewidth}{bien que fûté, le chat ne peut attrapper d'un coup}
...
\begin{verse}[\versewidth]
  ...
  bien que fûté, le chat ne peut attrapper d'un coup \\
...
\begin{verse}[\versewidth]
  ...
  le métier du passé a tissé la loi; \\
