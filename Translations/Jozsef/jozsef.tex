...
\begin{verse}%[\versewidth]
  ...
  The conscience will come knocking on the door \\
  and there will be no memory in which you would allow yourself. \\
  \ \\
  Your dog will be old and will settle next to you. \\
  You will rest during the day, dozing off on a chair \\
  because you will be afraid alone at night. \\
...
\begin{verse}[\versewidth]
  ...
  megöregszel\myfoot{perfect. vb. pref. \emph{meg-} +
    ...
    mind (negatively)/be bothered'} fogod,\myfoot{aux. vb. `to
