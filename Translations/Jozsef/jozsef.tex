...
\settowidth{\versewidth}{and I stand in the light of the compartments,}

\begin{verse}[\versewidth]
  I live by a railroad. Many a train \\
  comes and goes, and I watch from afar \\
  how the bright windows fly by \\
  in the waving fluff-darkness. \\
  So the lit-up days rush \\
  into the eternal night, \\
  and I stand in the light of the compartments, \\
...
\begin{verse}[\versewidth]
  ...
  dans l'obscurité ouatée qui fait signe. \\
...
\begin{verse}[\versewidth]
  ...
  a lengedező\myfoot{vb. \emph{leng} `to swing/sway/wave' +
    ...
    pres. part. \emph{-ő} $\rightarrow$ `waving'}
  ...
  rush/hurry' + 3rd pers. pl. ind. pres. indef. \emph{-(a)nak}} örök
  éjben \\
  kivilágított\myfoot{vb. pref. \emph{ki} `outwardly' + \emph{világ}
    `light/world' $\rightarrow$ arch. `illumination' + caus. vb.-forming
    \emph{-ít} `to make smth ...-like $\rightarrow$ `to illuminate' +
  past part. \emph{-ott}} nappalok\myfoot{\emph{nap} `day' + instr. \emph{-val}
