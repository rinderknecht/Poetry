...
\settowidth{\versewidth}{Maintenant mon rêve se pose, estompé, dans mes membres}
...
\begin{verse}[\versewidth]
  ...
  Maintenant mon rêve se pose, estompé, dans mes membres \\
...
\begin{verse}[\versewidth]
  ...
  pres. part. \emph{-ó}} porszem\footnote{`a speck of dust'}
  el\footnote{\emph{el nem} + past. part.; the verbal prefix \emph{el}
