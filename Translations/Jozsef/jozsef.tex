...
\begin{verse}%[\versewidth]
  ...
  It suits my Poverty, who loves you, \\
  and the Lord loves you also very much, \\
  and He also loves me. \\
  The Lord never comes in great radiance, \\
...
\begin{verse}[\versewidth]
  ...
  \emph{-ség} (state of being) $\rightarrow$ `poverty' + 1st
  ...
  elromoljanak\myfoot{vb. pref. \emph{el-} completion +
    vb. \emph{romlik} `to break down/deteriorate/devalue' + 3rd
    pers. pl. subj. indef. \emph{-janak}} \\
  szemeim,\myfoot{\emph{szem} `eye' + 1st
    pers. sg. mult. poss. \emph{-eim}} akik \\
  nagyon kívánnak látni téged. \\
  És nagyon szépen néznek majd terád \\
  ha visszajössz \\
  vigyázva foglak megcsókolni, \\
