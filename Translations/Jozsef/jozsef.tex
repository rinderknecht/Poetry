...
\begin{verse}[\versewidth]
  ...
  y, en sus sueños cansados y quebrados, \\
...
\begin{verse}[\versewidth]
  ...
  majd\myfoot{adv. `sometime/later'}
  elmosolyodnak\myfoot{perfect. vb. pref. \emph{el-} + \emph{mosoly}
  `smile'+ \textbf{???}}
...
\begin{verse}[\versewidth]
  ...
  cuando llega la noche, un sol brilla aquí dentro. \\
\end{verse}
...
\begin{verse}[\versewidth]
  ...
  Ninguna paleta asada logra mi boca \\
