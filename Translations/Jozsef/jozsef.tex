...
\begin{verse}[\versewidth]
  ...
  to the taciturn, austere day labourers, \\
...
\begin{verse}[\versewidth]
  ...
  vers les journaliers taciturnes et austères, \\
...
\settowidth{\versewidth}{y ahora la luz suave de mi pan queda más pura.}
...
\begin{verse}[\versewidth]
  ...
  y ahora la luz suave de mi pan queda más pura. \\
  ...
  y me ama también. \\
  El Señor no viene nunca con gran esplendor, \\
  no quiere dañar a mis ojos, \\
  que anhelan verte, \\
  ...
  y cómo eso resonará en casa de los vecinos, \\
  hacia los taciturnos y austeros jornaleros, \\
  y, en sus sueños cansados y rotos, \\
  ellos también se sonreirán. \\
\end{verse}
