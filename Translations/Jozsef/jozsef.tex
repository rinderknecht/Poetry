...
nights. In verse~6, I translated `is in order' instead of the more
literal `is the order', for it is more dynamic and comes with an
injunction to readiness.
