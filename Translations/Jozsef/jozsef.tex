...
\begin{verse}%[\versewidth]
  ...
  how you hurt those you are proud of today. \\
  The conscience comes knocking on the door \\
  and there is no memory in which you would allow yourself. \\
  \ \\
  Your dog will be old and settle next to you. \\
  You rest during the day, dozing off on a chair \\
  because you are afraid alone at night. \\
  Shadows fall on the trembling old wife. \\
  \ \\
...
\begin{verse}[\versewidth]
  ...
  hogy\myfoot{adv. `how'} bántasz \myfoot{vb. \emph{bán} `to
    mind (negatively)/be bothered' + caus. \emph{-t}: `to hurt' + 2nd
    pers. sg. ind. pres. def.} --- azt,\myfoot{\emph{az} `that' +
  ...
  emlék,\myfoot{`memory/souvenir'} melyben\myfoot{lit. \emph{mely}
    `which/that' + innes. \emph{-ben} `in'} magadra\myfoot{\emph{maga}
    `oneself' + subl. \emph{-ra} `into'}
  hagyna.\myfoot{vb. \emph{hagy} `to allow' + 2nd
    pers. sg. form. cond. pres. indef. \emph{-na}} \\
  ...
  áll\myfoot{vb. `to stand'} ifju\myfoot{\textbf{\emph{ifjú}}?
    ...
    pers. sg. single-poss. poss. \emph{-ed}} Hozzá motyogod: \\
  "Nem öleltem meg, hiszen nem szerettem." \\
  \ \\
  "Mit is tehettem volna?" --- kérdezed, \\
  de fogatlan szád már nem válaszolhat; \\
