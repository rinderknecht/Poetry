...
\textbf{hajnal} `dawn' \\
\textbf{hajnalban} `dawn' + innes. \emph{-ban} `in' \\
...
+ refl. \emph{-ik} + 2nd pers. inform. sg. ind. pres. indef. + polar interr. \emph{-e} \\
...
\textbf{közben} `interval' + innes. \emph{-ben} `in' \\
...
pers. sg. single\hyp{}poss. \emph{-m} + innes. \emph{-ban} `in' \\
