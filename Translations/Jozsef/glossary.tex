...
pers. sg. single\hyp{}poss. \emph{-om} + acc. \emph{-at} \\
\textbf{autó} `car' \\
...
pers. pl. single\hyp{}poss. \emph{-uk} + super. \emph{-on} `on' \\
%%
\ \\
...
pers. sg. single\hyp{}poss. \emph{-om} + subl. \emph{-ra} `on[to]' \\
...
\textbf{kenyeréből} \emph{kenyér} `bread' + 3rd pers. poss
single\hyp{}poss. \emph{-é} + elative \emph{-ből} `from, out of' \\
