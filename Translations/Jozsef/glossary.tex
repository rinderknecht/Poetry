...
\textbf{el} adv., conj. `afar, far away' \textbar\textbar{} \emph{el nem} + past. part. \textbar\textbar{} perf. vb. pref. \\
...
\textbf{jár} vb. `to move (location), to walk, to go' \\
...
pers. sg. single\hyp{}poss. \emph{-e} + 3rd pers. pl. $\rightarrow$ pron. `between them' \\
\textbf{kutya} `dog' \\
\textbf{különös} `strange' \\
\textbf{küszöbömig} \emph{küszöb} `threshold' + 1st
...
`onto' \\
\textbf{magamban} \emph{maga} `oneself' + 1st
pers. sg. pers. \emph{-m} $\rightarrow$ `myself' + innes. \emph{-ban}
`in' \\
...
\textbf{tedd} vb. \emph{tesz} `to place, to put' + 2nd
