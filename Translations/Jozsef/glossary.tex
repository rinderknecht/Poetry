...
\textbf{árnyak} \emph{árny} `shadow, ghost' + nom. pl. \emph{-ak} \\
\textbf{árnyát} \emph{árny} `shadow, ghost' + 3rd pers. sg. single
...
pers. sg. single-poss. poss. $\rightarrow$ `your dog' \\
...
\textbf{ég} vb. `to be on fire', 3rd pers. sg. ind. pres. indef. \\
...
`cogwheel' + 3rd pers. sg. single poss. \emph{-e} + subl. \emph{-re}
`towards' \\
...
noun\hyp{}forming \emph{-ik} $\rightarrow$ `another' + 3rd
  pers. sg. single poss. \emph{-a} + acc. \emph{-t}
  $\rightarrow$ \emph{-át} \\
...
`from, out of' \\
\textbf{száll} vb. `to land, to come down', 3rd
pers. sg. ind. pres. \\
...
abst. noun\hyp{}forming \emph{-ség} + 1st pers. sg. single poss. \emph{-em} +
allat. \emph{-hez} `to' \\
...
pers. sg. single poss. \emph{-e} `of' $\rightarrow$ \emph{töve} +
...
pers. sg. single poss. \emph{-am} + subl. \emph{-ra} `onto, on' \\
