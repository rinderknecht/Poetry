...
\poemtitle*{V\footnote{Il s'agit probablement d'un souvenir de
  l'enfance de József, quand sa famille était si pauvre qu'à
...
\poemtitle*{VIII\footnote{Il s'agit probablement d'un souvenir de
  l'emprisonnement de József en \oldstylenums{1931}.}}
...
\poemtitle*{IX\footnote{Les vers 1-2 font référence aux sons du fer
  ...
  fissure, ce qui ramène József à un événement pénible dans son passé,
  peut-être une rupture. Les vers 3-6 forment un chiasme: le vers~5
  fait écho au vers~4: pour éviter que son amour ne disparaisse, il
  continuera à aimer; le vers~6 répond au vers~3: au lieu de marteler
  la fissure pour la faire disparaître, József plie sous elle. Il n'y
  a alors plus besoin de forger une lame pour devenir fort. Le fors
  intérieur de József est doré comme l'éclat du foyer.}}
...
\poemtitle*{XI\footnote{Le dernier vers fait écho au premier: le
  ...
  au sens figuré, ce terme peut aussi désigner la joie, d'où ma
  traduction: «~la lumière du jour s'amusait~».}}
