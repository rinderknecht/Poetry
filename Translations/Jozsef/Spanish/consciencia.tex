...
\begin{verse}
  ...
  como pequeñas mariposas, las hojas. \\
\end{verse}
...
\poemtitle*{V\footnote{Se trata probablemente de un recuerdo de la
  infancia del autor, cuando su familia era tan pobre que, a veces, él
  robaba carbones de los vagones en la estación de tren de carga,
  cerca de su casa. Vease \emph{Descargan la madera}, página~\pageref{descargan_la_madera}.}}
...
\begin{verse}
  ...
  cruda, extraña-dulce. \\
  Haciéndome el muerto, miraba al guardia \\
  --- ¿que sentía qué? --- \\
...
\begin{verse}
  ...
  con los hilos brillantes de la suerte \\
  el telar del pasado había tejido la ley; \\
  por debajo el anhelo de mis sueños\footnote{El original
  es \emph{álmaim gőzei}, literalmente «~el vapor de mis sueños~», o,
  figurativamente, «~mis sueños turbulentes, el anhelo de mis
  sueños~».} \\
  miré de nuevo en los cielos \\
  y vi el tapiz de la ley \\
  siempre destramarse en alguna parte. \\
\end{verse}

\bigskip

\poemtitle*{VIII\footnote{Probablemente un recuerdo de la
  encarcelación del autor en \oldstylenums{1931}.}}
...
\poemtitle*{IX\footnote{Los versos 1-2 se refieren a los sonidos del
  hierro forjado y templado en agua. El herrero hace desaparecer una
  grieta, lo que lleva el narrador a un momento doloroso de su pasado,
  tal vez una separación. Los versos 3-6 forman un quiasmo: el verso~5
  responde al verso~4: para evitar que su amor desaparezca, tiene que
  seguir amando; el verso~6 responde al verso~3: en lugar de martillar
  la grieta, el narrador pliega debajo. Así no hace falta forjar una
  hoja para ser más fuerte. El fuero interior del narrador es dorado
  como el brillo de la fragua.}}
...
\poemtitle*{X\footnote{El hombre integral sabe que sus padres no
  pueden protegerlo de la verdad de su mortalidad. Esa verdad no la
  aprecian los dioses, que son inmortales, ni los sacerdotes, que
  predican vida eterna. Véase también página~\pageref{para_flora}.}}
\label{consciencia_X}
...
\begin{verse}
  ...
  el que no es ni un dios ni un sacerdote, \\
...
\poemtitle*{XI}
%% \footnote{El último verso es el
%%   eco del primero: el primer verso es la visión de la felicidad y el
%%   último evoca la luz y el juego: el original húngaro usa la
%%   palabra \emph{fény} para «~luz~», pero, figurativamente, también
%%   significa alegría, así mi traducción «~la luz del día
%%   jugueteaba~».}
...
\begin{verse}
  ...
  su sonrisa curva se balanceaba. \\
...
\begin{verse}
  ...
  a la oscuridad vacilante y vellosa. \\
