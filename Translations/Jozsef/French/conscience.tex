...
\begin{verse}
  ...
  Maintenant estompé, mon rêve descend dans \\
  mes membres, et le monde de fer est l'ordre. \\
...
\begin{verse}
  ...
  --- aussi futé soit-il, le chat ne peut attraper \\
  d'un coup la souris dehors et la souris dedans.
\end{verse}
...
\begin{verse}
  ...
  le monde gît en vrac; chaque chose \\
  presse, pèse, s'arrime à l'autre, \\
...
\poemtitle*{V\footnote{Il s'agit probablement d'un souvenir de
  l'enfance de l'auteur, quand sa famille était si pauvre qu'à
  l'occasion il volait des charbons des wagons à la gare de fret près
  de sa maison. Voir \emph{Ils déchargent le bois}, page~\pageref{ils_dechargent_le_bois}.}}
...
\begin{verse}
  ...
  --- ainsi tu seras libre s'il se complaît \\
...
\begin{verse}
  ...
  avec les fils scintillants de la chance \\
  le métier du passé avait tissé la loi; \\
  par dessous la passion ardente de mes rêves,\footnote{L'original est
  \emph{álmaim gőzei}, littéralement «~la vapeur de mes rêves~», ou,
  au sens figuré, «~mes rêves turbulents, la passion ardente de mes
  rêves~».} \\
  j'ai regardé à nouveau dans les cieux \\
  et j'ai vu la tapisserie de la loi \\
  toujours se défaire quelque part.
\end{verse}

\bigskip

\poemtitle*{VIII\footnote{Il s'agit probablement d'un souvenir de
  l'emprisonnement de l'auteur en \oldstylenums{1931}.}}
...
\poemtitle*{IX\footnote{Les vers 1-2 font référence aux sons du fer
  forgé et trempé dans l'eau. Le forgeron fait disparaître une
  fissure, ce qui ramène le narrateur à un événement pénible dans son
  passé, peut-être une rupture. Les vers 3-6 forment un chiasme: le
  vers~5 fait écho au vers~4: pour éviter que son amour ne
  disparaisse, il continuera à aimer; le vers~6 répond au vers~3: au
  lieu de marteler la fissure, le narrateur plie sous elle. Il n'y a
  alors plus besoin de forger une lame pour devenir fort. Le fors
  intérieur du narrateur est doré comme l'éclat du foyer.}}
...
\poemtitle*{X\footnote{L'homme intégral sait que ses
  parents ne peuvent plus le protéger de la vérité de sa
  mortalité. Cette vérité n'est pas chérie par les dieux, qui sont
  immortels, ni par les prêtres, qui prêchent la vie éternelle. Voir aussi page~\pageref{pour_flora}.}}
\label{conscience_X}
...
\poemtitle*{XI}
%% \footnote{Le dernier vers fait écho au premier: le
%%   premier est la vue du bonheur et le dernier évoque la lumière et le
%%   jeu: l'original hongrois emploie \emph{fény} pour «~lumière~», mais,
%%   au sens figuré, ce terme aussi désigne la joie, d'où ma traduction:
%%   «~la lumière du jour s'amusait~».}
