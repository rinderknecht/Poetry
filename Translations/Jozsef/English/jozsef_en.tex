...
\begin{verse}
  ...
  you who know and love me, \\
  since you sail the void \\
  and know what will come, like a soothsayer,

  for the silence\footnote{The narrator sometimes refers to his soul
  as a silence (\emph{csend}), like here, or a muteness
  (\emph{némaság}). See \emph{The leaves in the tree},
  page~\pageref{the_leaves_in_the_tree}.} appeared in your dreams \\
  in human form, \\
...
\begin{verse}
  ...
  page~\pageref{only_you_should_read_my_poems}, where the narrator
  refers to his soul as a silence or muteness.} too \\
