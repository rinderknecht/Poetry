...
% Geometry
%
\usepackage[papersize={12.85cm,19.84cm},includehead,includefoot,bindingoffset=1cm,showframe,showcrop]{geometry}
...
\usepackage[main=hungarian,french]{babel}
...
\begin{verse}[\versewidth]
  ...
  ha\myfoot{conf. `if' + cond. or `when/once'} áhit.\myfoot{vb. `to
    wish (for smth)'} \\
...
\noindent \textbf{Consciousness (\emph{Eszmélet}, \oldstylenums{1934})}
...
\begin{verse}%[\versewidth]
  ...
  Les ombres couvriront la vieille dame tremblante. \\
  \ \\
  Ton vieux chien gémira parfois, \\
  mais la pièce redevient silencieuse, tout est en ordre, \\
  et pourtant quelqu'un du passé \\
  manque dans le silence solitaire. \\
  \ \\
