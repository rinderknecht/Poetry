...
\begin{verse}
  La poutre bleue entre le deux pôles de ta poitrine \\
  --- Le rêve de l'acrobate s'y tient. \\
  \ \\
  Les nuages se sont défait, \\
  alors tu songes à prendre ton envol, \\
  et je t'ai déjà cherchée jusqu'aux confins. \\
  \ \\
  ...
  Les scarabées fatigués trouvent leur chemin \\
  vers la maison quand le soir tombe, \\
  et le Seigneur, les mains ouvertes, \\
  jusqu'aux genoux dans le clapotis paisible, \\
  les attend au bout de leur chemin... \\
  \ \\
