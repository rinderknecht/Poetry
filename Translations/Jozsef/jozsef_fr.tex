...
\begin{verse}
  ...
  Dans leurs cœurs, \\
  de beaux feux verdoyants brûlent. \\
  \ \\
...
\begin{verse}
  ...
  et les braises de son désespoir\hspace*{-1mm} \\
  se sont enflammées de mon amour. \\
  \ \\
  Depuis que je t'ai vue, \\
  ...
  \ \\
  \oldstylenums{11} avril \oldstylenums{1921}
\end{verse}
...
\begin{verse}
  ...
  \ \\
  \oldstylenums{1921}. ápr. \oldstylenums{11}.
\end{verse}
