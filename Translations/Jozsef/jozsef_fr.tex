...
\begin{verse}%[\versewidth]
  ...
  et sais ce qui adviendra, comme un devin, \\
  \ \\
  car le silence apparaît dans tes rêves \\
  sous la forme d'un être humain, \\
  et dans ton cœur parfois s'attarde \\
  le tigre et le chevreuil apprivoisé. \\
  \ \\
...
\begin{verse}%[\versewidth]
  ...
  comme jamais avant. \\
  \ \\
  Quel éclat de la vaste nuitée \\
  est cette lourde nuit, \\
  qu'elle tombe sur nous \\
  comme un fer sur la poussière? \\
  \ \\
  Désir né du soleil! \\
  Quand l'ombre tombe sur le lit, \\
  pourrais-tu aussi veiller \\
  toute la nuit? \\
  \ \\
  Devant l'entrepôt \\
  une lampe poussiéreuse brûle. \\
  Elle est à peine visible, pas lumineuse; \\
  ainsi est le vœu pieux: \\
  il cligne vivement, \\
  mais le ciel est une vaste lumière morte. \\
  \ \\
  \oldstylenums{1933}
\end{verse}
