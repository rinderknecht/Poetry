...
\poemtitle*{II\footnote{Verses 1-4 are about the night, verses 5-7 transition to the day, and
...
\poemtitle*{I\footnote{Chiastic structure: \\
...
\poemtitle*{II\footnote{Chiastic structure: \\
...
\poemtitle*{III\footnote{József cannot pursue his art and, at the same time, keep a job that
...
\poemtitle*{IV\footnote{`To be or not to be' is usually construed as the dichotomy between
...
\poemtitle*{III\footnote{Chiastic structure: \\
...
\poemtitle*{IV\footnote{Chiastic structure: \\
...
\poemtitle*{VI\footnote{We are not captives of the world, but of our own heart, which invited
...
\poemtitle*{V\footnote{Chiastic structure: \\
...
\poemtitle*{VI\footnote{Chiastic structure: \\
...
\poemtitle*{VII\footnote{Whereas verses 1-2 echo the ancient mechanical understanding of the
...
aerostat, whose aeronaut is József, where hiss dreams are the steam that
tries to lift him up, and the law is the envelope, whose tears are
József's constant misfortune. (The metaphor is a little off, as
balloons use hot air, not steam.)}}
...
\poemtitle*{VII\footnote{Chiastic structure: \\
...
\poemtitle*{VIII\footnote{Chiastic structure: \\
...
\poemtitle*{X\footnote{The integral man (the Hungarian language is actually gender neutral)
...
nor by Christian priests, who preach eternal life.}}
...
\poemtitle*{IX\footnote{Chiastic structure: \\
...
\poemtitle*{X\footnote{Chiastic structure: \\
...
\poemtitle*{XI\footnote{While this seems a rather descriptive poem, the first and last two
...
\poemtitle*{XI\footnote{Chiastic structure: \\
...
\poemtitle*{XII\footnote{Chiastic structure: \\
