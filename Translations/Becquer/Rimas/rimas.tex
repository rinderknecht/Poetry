...
\begin{center}
  \textbf{34}
  \addcontentsline{toc}{subsection}{\emph{34.\ Elle traverse muette,
      et ses mouvements...}}
\end{center}
...
\begin{center}
  \textbf{35}
  \addcontentsline{toc}{subsection}{\emph{35.\ Ton oubli ne m'admira pas! Bien que d'un jour...}}
\end{center}
...
\begin{center}
  \textbf{36}
  \addcontentsline{toc}{subsection}{\emph{36.\ Si de nos turpitudes on
    écrivait l'histoire dans un livre...}}
\end{center}
...
\begin{center}
  \textbf{37}
  \addcontentsline{toc}{subsection}{\emph{37.\ Avant toi je mourrai: caché...}}
\end{center}
...
\begin{center}
  \textbf{39}
  \addcontentsline{toc}{subsection}{\emph{39.\ Pourquoi me le dire? Je sais: elle est changeante...}}
\end{center}
...
\begin{center}
  \textbf{44}
  \addcontentsline{toc}{subsection}{\emph{44.\ Comme dans un livre
    ouvert...}}
\end{center}
...
\begin{center}
  \textbf{45}
  \addcontentsline{toc}{subsection}{\emph{45.\ À la clef d'un arc en
    ruine...}}
\end{center}
