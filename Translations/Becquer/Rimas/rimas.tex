...
préface. Malheureusement, la révolution antimonarchique de 1868 vit le
saccage du domicile de l'homme d'État et la disparition du
...
semble-t-il. Cette œuvre poétique fit partie de la publication de
deux volumes posthumes intitulés \emph{Obras} (Œuvres), en
1871. Presque tous les poèmes furent retenus, mais dans un ordre
thématique.
...
Orbis. Nous avons ajouté un chapitre intitulé \emph{Autre rimes}
regroupant des poèmes attribués à l'auteur par la critique, mais qui
ne faisaient ni partie du \emph{Livre des moineaux} ni des
\emph{Œuvres}.

Les poèmes de Bécquer sont connus aujourd'hui sous le vocables de
\emph{Rimas} (rimes), car il les appelaient ainsi dans auprès de ses
...
conserver ou recréer certaines allitérations, mais surtout les
structures entre strophes et vers, comme par exemple la mise en
exergue de certains mots, au début ou à la fin de certains
vers. L'espagnol du milieu du XIX\ieme{} siècle a changé: nous avons
consulté des sources philologiques pour traduire correctement certains
faux\hyp{}amis. Par ailleurs, certains termes religieux sont devenus
obscurs: nous avons fourni des notes pour les expliquer
brièvement. Bécquer avait une ponctuation idiosyncratique ---~quand
elle n'était pas absente: nous avons pris la liberté d'user d'une
ponctuation moderne qui sert la compréhension, surtout dans les longs
poèmes.
