...
Gustavo Adolfo Bécquer publia une quinzaine de poèmes dans des revues
littéraires et artistiques. Il remit un recueil manuscrit de ses
poèmes à son protecteur, Luis González Bravo, alors premier ministre
espagnol de la reine Isabel~II, pour qu'il le
préface. Malheureusement, la révolution antimonarchique de 1868 vit
le saccage du domicile de l'homme d'État et la disparition du
manuscrit. Par la suite, Bécquer reconstitua (de mémoire, prétend-il)
le livre perdu, qu'il intitula \emph{El libro de los gorriones} (Le
livre des moineaux). Le projet prévoyait une première partie en prose
(restée inachevée), et la seconde (complète, semble-t-il) en
vers. Cette œuvre poétique fit partie de la publication de deux
volumes posthumes intitulés \emph{Obras} (Œuvres), en 1871. Presque
tous les poèmes furent retenus, mais dans un ordre thématique.
...
aussi une édition de \emph{Rimas y leyendas} de 1984 aux éditions
Orbis (Espagne). Nous n'avons lu aucune traduction. Nous avons ajouté
un chapitre intitulé \emph{Autre rimes} regroupant des poèmes
attribués à l'auteur par la critique, mais qui ne faisaient pas partie
originellement ni du \emph{Livre des moineaux} ni des \emph{Œuvres}.

Les poèmes de Bécquer sont connus aujourd'hui sous le vocables de
\emph{Rimas} (rimes), car il les appelaient ainsi dans sa
correspondance avec ses amis. Malgré l'apparence de vers libres,
beaucoup de ses poèmes riment au sens où ils contiennent des
correspondances internes, souvent des assonances, des allitérations,
des répétitions, des structures parallèles ou en opposition
etc. Bécquer joue beaucoup avec la syntaxe espagnole pour réaliser ces
rimes. Plutôt que faire de même en français, où l'ordre des
propositions est plus contraint, nous avons opté pour une traduction
plus fluide, surtout dans les poèmes les plus longs, pour ne pas
égarer le lecteur. Nous avons néanmoins tâché de conserver ou recréer
certaines allitérations, mais surtout les structures entre strophes et
vers, comme par exemple la mise en exergue de certains mots, au début
ou à la fin de certains vers. L'espagnol du milieu du XIX\ieme{}
siècle a changé: nous avons consulté des sources philologiques pour
traduire correctement certains faux\hyp{}amis. Par ailleurs, certains
termes religieux sont devenus obscurs: nous avons fourni des notes
pour les expliquer brièvement. Bécquer avait une ponctuation
...
habituelle: destin, incertitude, mort; les galanteries amoureuses;
l'amour perdu, avec ses regrets, les nuits sans sommeil, mais aussi le
dépit et la rancune; la musique; enfin, la métapoésie, c'est-à-dire
des poèmes sur l'écriture poétique elle-même, sur le sujet poétique
(en particulier, l'idéal féminin), avec parfois des éléments
platoniciens qui touchent au symbolisme.
