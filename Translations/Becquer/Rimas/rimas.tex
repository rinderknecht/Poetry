...
\begin{center}
  \textbf{VI}
  \addcontentsline{toc}{subsection}{\emph{VI.\ Comme la brise qui
    rafraîchit le sang...}}
\end{center}
...
\begin{center}
  \textbf{VII}
  \addcontentsline{toc}{subsection}{\emph{VII.\ Dans l'angle obscur du
    salon...}}
\end{center}
...
\begin{center}
  \textbf{VIII}
  \addcontentsline{toc}{subsection}{\emph{VIII.\ Quand je vois
    l'horizon bleu...}}
\end{center}
...
\begin{verse}[\versewidth]
  ...
  en atomes légers, \\
  défait comme elle. %% cual ella deshecho/a ???
  ...
  de divin ici en moi!... %%% Points de suspension ?
\end{verse}
...
\begin{center}
  \textbf{IX}
  \addcontentsline{toc}{subsection}{\emph{IX.\ Le zéphir qui gémit
    faiblement...}}
\end{center}
...
\begin{center}
  \textbf{X}
  \addcontentsline{toc}{subsection}{\emph{X.\ Les invisibles atomes de
...
\begin{verse}[\versewidth]
  ...
  Dis-moi...? Silence! C'est l'amour qui passe! %% ¡Es el amor que pasa! (??)
\end{verse}
...
\begin{center}
  \textbf{XI}
  \addcontentsline{toc}{subsection}{\emph{XI.\ Je suis ardente, je
    suis brune...}}
\end{center}
