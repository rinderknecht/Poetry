...
\begin{center}
  \textbf{4}
  \addcontentsline{toc}{subsection}{\emph{4.\ Ne dites pas que, épuisé
    son trésor...}}
\end{center}
...
\begin{center}
  \textbf{9}
  \addcontentsline{toc}{subsection}{\emph{9.\ Le zéphyr qui gémit
    faiblement...}}
\end{center}
...
\begin{center}
  \textbf{37}
  \addcontentsline{toc}{subsection}{\emph{37.\ Je mourrai avant toi...}}
\end{center}
...
\begin{center}
  \textbf{54}
  \addcontentsline{toc}{subsection}{\emph{54.\ Quand nous évoquons à nouveau les heures fugaces du passé...}}
\end{center}
...
\begin{center}
  \textbf{63}
  \addcontentsline{toc}{subsection}{\emph{63.\ Comme un essaim
    d'abeilles irritées...}}
\end{center}
...
\begin{center}
  \textbf{74}
  \addcontentsline{toc}{subsection}{\emph{74.\ Les habits défaits, les
    épées nues...}}
\end{center}
...
\begin{center}
  \textbf{75}
  \addcontentsline{toc}{subsection}{\emph{75.\ Serait-il vrai que
...
\begin{center}
  \textbf{76}
  \addcontentsline{toc}{subsection}{\emph{76.\ Dans l'imposante nef de
    l'église byzantine...}}
\end{center}
...
\begin{center}
  \textbf{77}
  \addcontentsline{toc}{subsection}{\emph{77.\ Tu dis que tu as un cœur...}} \end{center}
...
\begin{center}
  \textbf{78}
  \addcontentsline{toc}{subsection}{\emph{78.\ Feignant des réalités
    avec l'ombre vaine...}}
\end{center}
...
\begin{center}
  \textbf{79}
  \addcontentsline{toc}{subsection}{\emph{78.\ Une femme m'a
    empoisonné l'âme...}}
\end{center}
...
\begin{center}
  \textbf{80}
  \addcontentsline{toc}{subsection}{\emph{80.\ La vies est un songe...}}
\end{center}
