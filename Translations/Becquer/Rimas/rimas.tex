...
\begin{center}
  \textbf{1 [XLVIII]}
  \addcontentsline{toc}{subsection}{\emph{1.\ Comme s'arrache le fer d'une plaie...}}
\end{center}
...
\begin{verse}[\versewidth]
  ...
  Son image tenace vient encore à mon esprit \\
...
\begin{center}
  \textbf{2 [XLVII]}
  \addcontentsline{toc}{subsection}{\emph{2.\ Je me suis penché sur
    les gouffres béants...}}
\end{center}
...
\begin{center}
  \textbf{3 [XLV]}
  \addcontentsline{toc}{subsection}{\emph{3.\ À la clef d'un arc mal assuré...}}
\end{center}
...
\begin{center}
  \textbf{4 [XXXVIII]}
  \addcontentsline{toc}{subsection}{\emph{4.\ Les soupirs sont air, et
    à l'air ils vont...}}
\end{center}
...
\begin{center}
  \textbf{5 [LXXII]}
  \addcontentsline{toc}{subsection}{\emph{5.\ Les ondes ont une vague
    harmonie...}}
\end{center}
...
\begin{center}
  \textbf{6 [XVIII]}
  \addcontentsline{toc}{subsection}{\emph{6.\ Fatiguée par la danse...}}
\end{center}
...
\begin{center}
  \textbf{7 [XXVI]}
  \addcontentsline{toc}{subsection}{\emph{7.\ Je vais contre mes intérêts en le confessant...}}
\end{center}
...
\begin{center}
  \textbf{8 [LVIII]}
  \addcontentsline{toc}{subsection}{\emph{8.\ Veux-tu de ce
...
\begin{center}
  \textbf{9 [LV]}
  \addcontentsline{toc}{subsection}{\emph{9.\ Dans le tumulte
...
\begin{center}
  \textbf{10 [XLIV]}
  \addcontentsline{toc}{subsection}{\emph{10.\ Comme dans un livre
    ouvert...}}
\end{center}
...
\begin{center}
  \textbf{11 [I]}
  \addcontentsline{toc}{subsection}{\emph{11.\ Je sais un hymne géant et étrange...}}
\end{center}
...
\begin{verse}[\versewidth]
  ...
  si je peux te le conter seul à seul à l'oreille \\
...
\begin{center}
  \textbf{12 [L]}
  \addcontentsline{toc}{subsection}{\emph{12.\ Comme le sauvage aux mains malhabiles...}}
\end{center}
...
\begin{center}
  \textbf{13 [VII]}
  \addcontentsline{toc}{subsection}{\emph{13.\ Dans l'angle obscur du
    salon...}}
\end{center}
...
\begin{center}
  \textbf{14 [XLIX]}
  \addcontentsline{toc}{subsection}{\emph{14.\ Parfois je la rencontre
    de par le monde...}}
\end{center}
...
\begin{center}
  \textbf{15 [II]}
  \addcontentsline{toc}{subsection}{\emph{15.\ \emph{Saeta} qui
    traverse en volant...}}
\end{center}
...
\begin{center}
  \textbf{16 [XLII]}
  \addcontentsline{toc}{subsection}{\emph{16.\ Quand on me le conta, je
    sentis le froid...}}
\end{center}
...
\begin{center}
  \textbf{17 [LIX]}
  \addcontentsline{toc}{subsection}{\emph{17.\ Moi, je sais quel est
...
\begin{center}
  \textbf{18 [LXVII]}
  \addcontentsline{toc}{subsection}{\emph{18.\ Quelle merveille que de
    voir le jour...}}
\end{center}
...
\begin{center}
  \textbf{19 [XXII]}
  \addcontentsline{toc}{subsection}{\emph{19.\ Comment vit cette rose que tu as prise...}}
\end{center}

\settowidth{\versewidth}{Comment vit cette rose que tu as prise}

\begin{verse}[\versewidth]
  Comment vit encore cette rose que tu as prise \\
  contre ton cœur? \\
...
\begin{center}
  \textbf{20 [LVI]}
  \addcontentsline{toc}{subsection}{\emph{20.\ Aujourd'hui comme hier, demain comme aujourd'hui...}}
\end{center}
...
\begin{verse}[\versewidth]
  ...
  dans mes iris tes iris bleus.\footnote{NDT. Ce quatrain est célèbre dans
  le monde hispanophone. Dans l'original figure \emph{pupila}
  (pupille), que nous avons courageusement corrigé en \emph{iris} pour
  ne pas troubler la lecture, car le lecteur francophone n'a
  probablement pas déjà appris par cœur ce poème. Voir poèmes 21, 25 et~29.} \\
...
\begin{center}
  \textbf{22 [XXIII]}
  \addcontentsline{toc}{subsection}{\emph{22.\ Pour un regard, un monde;...}}
\end{center}
...
\begin{center}
  \textbf{23 [LXXV]}
  \addcontentsline{toc}{subsection}{\emph{23.\ Serait-il vrai que
    quand le sommeil touche...}}
\end{center}
...
\begin{center}
  \textbf{24 [LXXIV]}
  \addcontentsline{toc}{subsection}{\emph{24.\ Les habits défaits, les
    épées nues...}}
\end{center}
...
\begin{center}
  \textbf{25 [VIII]}
  \addcontentsline{toc}{subsection}{\emph{25.\ Quand je regarde
    l'horizon bleu...}}
\end{center}
...
\begin{verse}[\versewidth]
  ...
  iris\footnote{NDT L'original emploie \emph{pupila} (pupille). Voir
  poèmes 21 et~29.} de feu,
...
\begin{center}
  \textbf{26 [XLI]}
  \addcontentsline{toc}{subsection}{\emph{26.\ Tu étais l'ouragan et
    moi la haute tour...}}
\end{center}
...
\begin{center}
  \textbf{27 [IX]}
  \addcontentsline{toc}{subsection}{\emph{27.\ Le zéphyr qui gémit
    faiblement...}}
\end{center}
...
\begin{center}
  \textbf{28 [XXXVII]}
  \addcontentsline{toc}{subsection}{\emph{28.\ Je mourrai avant toi...}}
\end{center}
...
\begin{center}
  \textbf{29 [XIII]}
  \addcontentsline{toc}{subsection}{\emph{29.\ Tes iris sont bleus...}}
\end{center}

\settowidth{\versewidth}{comme un point de lumière irradie une idée,}

\begin{verse}[\versewidth]
  Tes iris\footnote{NDT L'original emploie \emph{pupila} (pupille). Voir
  poèmes~21 et~25.} sont bleus et, quand tu ris, \\
  leur clarté suave me rappelle \\
  l'éclat tremblant du matin \\
  qui se reflète dans la mer.

  Tes iris sont bleus et, quand tu pleures, \\
  les larmes transparentes en eux \\
  me semblent gouttes de rosée \\
  sur une violette.

  Tes iris sont bleus et, si irradie une idée \\
...
\begin{center}
  \textbf{30 [XXXI]}
  \addcontentsline{toc}{subsection}{30.\ Notre passion fut une tragique saynète...}
\end{center}
...
\begin{center}
  \textbf{31 [XXV]}
  \addcontentsline{toc}{subsection}{\emph{31.\ Quand t'enveloppent dans la nuit...}}
\end{center}
...
\begin{center}
  \textbf{32 [LVII]}
  \addcontentsline{toc}{subsection}{\emph{32.\ Cette carcasse d'os et de peau...}}
\end{center}
...
\begin{center}
  \textbf{33 [XXIV]}
  \addcontentsline{toc}{subsection}{\emph{33.\ Deux rouges langues de feu...}}
\end{center}
...
\begin{center}
  \textbf{34 [XLIII]}
  \addcontentsline{toc}{subsection}{\emph{34.\ J'écartai la lumière...}} \end{center}
...
\begin{center}
  \textbf{35 [LII]}
  \addcontentsline{toc}{subsection}{\emph{35.\ Lames géantes qui vous
    brisez en mugissant...}}
\end{center}
...
\begin{center}
  \textbf{36 [LIV]}
  \addcontentsline{toc}{subsection}{\emph{36.\ Quand nous évoquons à nouveau les heures fugaces du passé...}}
\end{center}
...
\begin{center}
  \textbf{37 [XX]}
  \addcontentsline{toc}{subsection}{\emph{37.\ Elle sait, si parfois ses lèvres rouges...}}
\end{center}
...
\begin{center}
  \textbf{38 [LIII]}
  \addcontentsline{toc}{subsection}{\emph{38.\ Elles reviendront, les
    noires hirondelles...}}
\end{center}
...
\begin{center}
  \textbf{39 [IV]}
  \addcontentsline{toc}{subsection}{\emph{39.\ Ne dites pas que, épuisé
    son trésor...}}
\end{center}
...
\begin{center}
  \textbf{40 [XXX]}
  \addcontentsline{toc}{subsection}{\emph{40.\ Une larme pointait à
    ses yeux...}}
\end{center}
...
\begin{center}
  \textbf{41 [LX]}
  \addcontentsline{toc}{subsection}{\emph{41.\ Ma vie est une friche...}}
\end{center}
...
\begin{center}
  \textbf{42 [III]}
  \addcontentsline{toc}{subsection}{\emph{42.\ Secousse étrange qui
    agite les idées...}}
\end{center}
...
\begin{center}
  \textbf{43 [XVI]}
  \addcontentsline{toc}{subsection}{\emph{43.\ Si, quand les clochettes bleues de ton balcon...}}
\end{center}
...
\begin{center}
  \textbf{44 [LXXVII]}
  \addcontentsline{toc}{subsection}{\emph{44.\ Tu dis que tu as un cœur...}} \end{center}
...
\begin{center}
  \textbf{45 [LXI]}
  \addcontentsline{toc}{subsection}{\emph{45.\ En voyant mes heures de
    fièvre...}}
\end{center}
...
\begin{center}
  \textbf{46 [X]}
  \addcontentsline{toc}{subsection}{\emph{46.\ Les invisibles atomes de
...
\begin{center}
  \textbf{47 [LXV]}
  \addcontentsline{toc}{subsection}{\emph{47.\ Vint la nuit et point
    d'asile...}}
\end{center}
...
\begin{center}
  \textbf{48 [LXXVIII]}
  \addcontentsline{toc}{subsection}{\emph{48.\ Feignant des réalités
    avec l'ombre vaine...}}
\end{center}
...
\begin{center}
  \textbf{49 [LXIX]}
  \addcontentsline{toc}{subsection}{\emph{49.\ Nous naissons de l'éclair lorsqu'il brille,...}}
\end{center}
...
\begin{center}
  \textbf{50 [XVII]}
  \addcontentsline{toc}{subsection}{\emph{50.\ Aujourd'hui la terre et les cieux me sourient...}}
\end{center}
...
\begin{center}
  \textbf{51 [XI]}
  \addcontentsline{toc}{subsection}{\emph{51.\ Je suis ardente, je
    suis brune...}}
\end{center}
...
\begin{center}
  \textbf{52 [XIX]}
  \addcontentsline{toc}{subsection}{\emph{52.\ Quand sur ta poitrine
...
\begin{center}
  \textbf{53 [XXIX]}
  \addcontentsline{toc}{subsection}{\emph{53.\ Sur sa jupe elle tenait
  le livre ouvert...}}
\end{center}
...
\begin{center}
  \textbf{54 [XXXVI]}
  \addcontentsline{toc}{subsection}{\emph{54.\ Si l'on écrivait dans un livre...}}
\end{center}
...
\begin{center}
  \textbf{55\footnote{Ce poème ne fut pas publié dans \emph{Obras},
    ...
    l'auteur.}}
  \addcontentsline{toc}{subsection}{\emph{55.\ Une femme
...
\begin{center}
  \textbf{56 [LXII]}
  \addcontentsline{toc}{subsection}{\emph{56.\ D'abord une aube
    tremblante...}}
\end{center}
...
\begin{center}
  \textbf{57 [VI]}
  \addcontentsline{toc}{subsection}{\emph{57.\ Comme la brise qui
    rafraîchit le sang...}}
\end{center}
...
\begin{center}
  \textbf{58 [XXVIII]}
  \addcontentsline{toc}{subsection}{\emph{58.\ Quand, parmi l'ombre obscure...}}
\end{center}
...
\begin{center}
  \textbf{59 [LXX]}
  \addcontentsline{toc}{subsection}{\emph{59.\ Combien de fois, au
...
\begin{center}
  \textbf{60 [XV]}
  \addcontentsline{toc}{subsection}{\emph{60.\ Voile flottant de brume légère...}}
\end{center}
...
\begin{center}
  \textbf{61 [LXVIII]}
  \addcontentsline{toc}{subsection}{\emph{61.\ Je ne sais ce que j'ai
...
\begin{center}
  \textbf{62 [V]}
  \addcontentsline{toc}{subsection}{\emph{62.\ Esprit sans nom,
...
\begin{center}
  \textbf{63 [XXVII]}
  \addcontentsline{toc}{subsection}{\emph{63.\ Éveillée, je tremble à ta vue...}}
\end{center}
...
\begin{center}
  \textbf{65 [XXXIV]}
  \addcontentsline{toc}{subsection}{\emph{65.\ Muette, elle traverse
      et ses mouvements...}}
\end{center}
...
\begin{center}
  \textbf{66 [XL]}
  \addcontentsline{toc}{subsection}{\emph{66.\ Sa main dans mes mains...}}
\end{center}
...
\begin{center}
  \textbf{67 [LXVI]}
  \addcontentsline{toc}{subsection}{\emph{67.\ D'où je viens? Cherche
...
\begin{center}
  \textbf{68 [LXIII]}
  \addcontentsline{toc}{subsection}{\emph{68.\ Comme un essaim
    d'abeilles irritées...}}
\end{center}
...
\begin{center}
  \textbf{69 [XXXIII]}
  \addcontentsline{toc}{subsection}{\emph{69.\ C'est une question de mots, et pourtant...}}
\end{center}
...
\begin{center}
  \textbf{70 [LI]}
  \addcontentsline{toc}{subsection}{\emph{70.\ Du peu de vie qu'il me
    reste...}}
\end{center}
...
\begin{center}
  \textbf{71 [LXXIII]}
  \addcontentsline{toc}{subsection}{\emph{71.\ On clôt ses yeux
...
\begin{center}
  \textbf{72 [XIV]}
  \addcontentsline{toc}{subsection}{\emph{72.\ Je t'entrevis et l'image de tes yeux resta...}}
\end{center}
...
\begin{center}
  \textbf{73 [XXXII]}
  \addcontentsline{toc}{subsection}{\emph{73.\ Elle passait, irrésistible dans sa splendeur...}}
\end{center}
...
\begin{center}
  \textbf{74 [LXXVI]}
  \addcontentsline{toc}{subsection}{\emph{74.\ Dans l'imposante nef de
    l'église byzantine...}}
\end{center}
...
\begin{center}
  \textbf{75 [XXXIX]}
  \addcontentsline{toc}{subsection}{\emph{75.\ Pourquoi me le dire?...}}
\end{center}
...
\begin{center}
  \textbf{76 [LXXI]}
  \addcontentsline{toc}{subsection}{\emph{76.\ Je ne dormais pas,
...
\begin{center}
  \textbf{77 [XLVI]}
  \addcontentsline{toc}{subsection}{\emph{77.\ Elle m'a blessé en
...
\begin{center}
  \textbf{78 [XXXV]}
  \addcontentsline{toc}{subsection}{\emph{78.\ Ton oubli ne m'admira pas!...}}
\end{center}
...
\begin{center}
  \textbf{79 [XII]}
  \addcontentsline{toc}{subsection}{\emph{79.\ Petite, parce que tes
    yeux sont verts...}}
\end{center}
...
\begin{center}
  \textbf{80}
  \addcontentsline{toc}{subsection}{\emph{80.\ La vie est un songe...}}
\end{center}
...
\begin{center}
  \textbf{81}
  \addcontentsline{toc}{subsection}{\emph{81.\ Le soleil peut bien s'ennuager éternellement...}}
\end{center}
...
\begin{center}
  \textbf{82}
  \addcontentsline{toc}{subsection}{\emph{82.\ Ton haleine est l'haleine des fleurs...}}
\end{center}
...
\begin{center}
  \textbf{83}
  \addcontentsline{toc}{subsection}{\emph{83.\ La goutte de rosée qui dort...}}
\end{center}
...
\begin{center}
  \textbf{84}
  \addcontentsline{toc}{subsection}{\emph{84.\ Loin et parmi les arbres
...
\begin{center}
  \textbf{85}
  \addcontentsline{toc}{subsection}{\emph{85.\ Patriarches, qui furent la semence de l'arbre de la foi...}}
\end{center}
...
\begin{center}
  \textbf{86}
  \addcontentsline{toc}{subsection}{\emph{86.\ Solitaire, triste et muet est ce cimetière...}}
\end{center}
