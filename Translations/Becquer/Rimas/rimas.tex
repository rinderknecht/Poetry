...
% * Destin incertain / existentiel + la mort
% * Galanterie
% * L'amour perdu
% * La métapoésie
% * La femme-poème
...
\begin{center}
  \textbf{8 [LVIII]}
  \addcontentsline{toc}{subsection}{\emph{8.\ Veux-tu éviter l'amertume de la lie de ce nectar délicieux?...}}
\end{center}
...
\begin{center}
  \textbf{19 [XXII]}
  \addcontentsline{toc}{subsection}{\emph{19.\ Comment vit encore cette rose que tu as prise...}}
\end{center}
...
\begin{center}
  \textbf{29 [XIII]}
  \addcontentsline{toc}{subsection}{\emph{29.\ Tes yeux sont bleus...}}
\end{center}
...
\begin{center}
  \textbf{34 [XLIII]}
  \addcontentsline{toc}{subsection}{\emph{34.\ J'écartai la lampe et
...
\begin{center}
  \textbf{43 [XVI]}
  \addcontentsline{toc}{subsection}{\emph{43.\ Si, quand les
...
\begin{center}
  \textbf{45 [LXI]}
  \addcontentsline{toc}{subsection}{\emph{45.\ En voyant mes heures
    lentes de fièvre...}}
\end{center}
...
\begin{center}
  \textbf{55\footnote{Ce poème ne fut pas publié dans \emph{Obras},
    ...
    de l'auteur, Julia Espín, mariée lors de la parution. Il
    est barré d'une croix dans le manuscrit, d'une encre autre que
    celle de l'auteur.}}
...
\begin{verse}[\versewidth]
  ...
  féminine, qui se suffit à elle-même se retrouve à la rime~75.} Bah!
...
\begin{center}
  \textbf{67 [LXVI]}
  \addcontentsline{toc}{subsection}{\emph{67.\ D'où viens-je? Cherche
...
\begin{center}
  \textbf{71 [LXXIII]}
  \addcontentsline{toc}{subsection}{\emph{71.\ On ferma ses yeux
...
\begin{center}
  \textbf{72 [XIV]}
  \addcontentsline{toc}{subsection}{\emph{72.\ Je t'entrevis et l'image de tes yeux persista...}}
\end{center}
...
\begin{center}
  \textbf{84}
  \addcontentsline{toc}{subsection}{\emph{84.\ Loin, parmi les arbres
...
\begin{center}
  \textbf{86}
  \addcontentsline{toc}{subsection}{\emph{86.\ Ce cimetière est solitaire, triste et muet...}}
\end{center}
