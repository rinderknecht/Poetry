...
\begin{verse}
  ...
  par arme blanche est récurrent chez \Becquer{}. Voir les rimes~16, 28
  et~77.} \\
...
\begin{verse}
  ...
  l'inexprimable «\,hymne\,» du premier quatrain. (\Becquer{} maitrisait le
...
\begin{verse}
  ...
  vallée du Guadalquivir, qui traverse Séville, la ville de \Becquer{},
...
\begin{verse}
  ...
  blessure par arme blanche est récurrent chez \Becquer{}. Voir les
  rimes~1, 28 et~77.} \\
...
\begin{verse}
  ...
  par arme blanche est récurrent chez \Becquer{}. Voir les rimes~1, 16 et~77.}
...
\begin{verse}
  ...
  rumeur sonore
  d'une harpe d'or, \\
  baiser du zéphyr,\footnote{Le mot \emph{aura} dans la poésie
  espagnole du XIX\ieme{} siècle, désignait un vent doux. Nous
  traduisons parfois par \emph{brise}. Voir rimes~5 et~27.} onde de
  lumière, \\
  tu es cela.
...
\begin{verse}
  ...
  commentaire de cette rime, indique que \Becquer{}, comme beaucoup de
  ses contemporains, utilisait \emph{bizantino} pour dire \emph{románico}
  (roman). Ailleurs, \Becquer{} utilise très souvent \emph{templo} (temple)
...
\begin{verse}
  ...
  par arme blanche est récurrent chez \Becquer{}. Voir les rimes~1, 16
  et~28.}
\end{verse}
...
\begin{verse}
  ...
  dans le paradis d'Allah. Elles ont de grands yeux noirs.} du
  Prophète.
