...
\begin{verse}[\versewidth]
  Fixing the firmament \\
  ---~the ocean between us \\
  I hoist sails and hide \\
  precious cargo \\
  like a winged thief

  %% My eyes wander in the firmament \\
  %% that same sky that separates us \\
...
%%  I smuggle my heart to you \\

  Will you forgive me \\
  after a season in hell?

  Your heart overturned \\
  like an inkwell on a page \\
  and night flooded \\
  snowy fields
