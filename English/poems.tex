...
\epigraph{
  %Un petit abreuvoir pour ceux que le langage a désertés. Pour
  %l'ombre des enfants. Pour les coups de marteaux des
  %cordonniers.
  %Pour les états qui précédent l'enfance. Quand on était
  %sans souffle. Quand on était sans lumière.
  For the states preceding infancy. When we were breathless. When we
  were without light.}{Pascal Guignard,
  \emph{All the World's Mornings} (1991)}
