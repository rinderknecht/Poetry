...
\begin{verse}[\versewidth]
  ...
  the round mirrors \\
  of iridescent water \\
  form a bondless kaleidoscope \\
  and show each other

  %% the boundless kaleidoscope \\
  %% of iridescent \\
  %% round \\
  %% mirrors of water \\
  %% showed each other
...
%% \begin{verse}%[\versewidth]
%%   Away the day streches \\
%%   between the clouds \\
%%   and the rain draws mirrors \\
%%   in the mud
...
%%   Stars blink leagues away \\


%%   In my eyes you strech \\
%%   mine between my feet

%%   The longing sketches you \\
%%   on the hill

%%   The shadow drowns \\
%%   the match of the eloquent

%%   You are them and you give yourself \\
%%   anyway
